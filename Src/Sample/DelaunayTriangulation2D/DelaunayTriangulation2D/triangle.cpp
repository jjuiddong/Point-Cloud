...
Triangle2::Triangle2(const Vec2f &_p1, const Vec2f &_p2, const Vec2f &_p3)
	:	p1(_p1), p2(_p2), p3(_p3),
		e1(_p1, _p2), e2(_p2, _p3), e3(_p3, _p1)
{}

bool Triangle2::containsVertex(const Vec2f &v)
{
	return p1 == v || p2 == v || p3 == v; 
}

bool Triangle2::circumCircleContains(const Vec2f &v)
{
