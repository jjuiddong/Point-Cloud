...
// #include <sys/time.h>
 ...
 #define REAL real                      /* float or real */
 ...
 /*****************************************************************************/
 /*                                                                           */
 /*  doubleprint()   Print the bit representation of a real.                */
 /*                                                                           */
 ...
 */
 ...
 /*****************************************************************************/
 /*                                                                           */
 /*  doublerand()   Generate a real with rand 53-bit significand and a    */
 ...
 real doublerand()
 {
   ...
   b = rand();
   c = rand();
   result = (real) (a - 1073741824.f) * 8388608.0f + (real) (b >> 8);
 ...
 /*****************************************************************************/
 /*                                                                           */
 /*  narrowdoublerand()   Generate a real with rand 53-bit significand    */
 /*                       and a rand exponent in [0, 7].                    */
 /*                                                                           */
 /*****************************************************************************/
 
 real narrowdoublerand()
 {
   real result;
   real expo;
   long a, b, c;
 ...
 /*****************************************************************************/
 /*                                                                           */
 /*  uniformdoublerand()   Generate a real with rand 53-bit significand.  */
 /*                                                                           */
 /*****************************************************************************/
 
 real uniformdoublerand()
 {
   real result;
   long a, b;
   ...
   a = rand();
   b = rand();
   result = (real) (a - 1073741824) * 8388608.0f + (real) (b >> 8);
   return result;
 }
 ...
 /*                                                                           */
 /*  `epsilon' is the largest power of two such that 1.0f + epsilon = 1.0f in   */
 ...
 REAL orient3dadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
 {
   ...
   if ((adxtail == 0.0f) && (bdxtail == 0.0f) && (cdxtail == 0.0f)
       ...
       && (adztail == 0.0f) && (bdztail == 0.0f) && (cdztail == 0.0f)) {
     return det;
   }
 ...
 REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent)
 {
   ...
   if ((aextail == 0.0f) && (aeytail == 0.0f) && (aeztail == 0.0f)
       && (bextail == 0.0f) && (beytail == 0.0f) && (beztail == 0.0f)
       && (cextail == 0.0f) && (ceytail == 0.0f) && (ceztail == 0.0f)
       && (dextail == 0.0f) && (deytail == 0.0f) && (deztail == 0.0f)) {
     return det;
   }
