...
BEGIN_MESSAGE_MAP(CDelaunayApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CDelaunayApp::OnAppAbout)
END_MESSAGE_MAP()
...
CDelaunayApp::CDelaunayApp()
{
	...
	SetAppID(_T("Delaunay.AppID.NoVersion"));
