...
{
	//const bool b1 = m_tr[0].m_plane.Distance(p) < 0;
	//const bool b2 = m_tr[1].m_plane.Distance(p) < 0;
	//const bool b3 = m_tr[2].m_plane.Distance(p) < 0;
	//const bool b4 = m_tr[3].m_plane.Distance(p) < 0;
	//return b1 && b2 && b3 && b4;
