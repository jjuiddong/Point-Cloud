...
Triangle2::Triangle2(const Vector3 &_p1, const Vector3 &_p2, const Vector3 &_p3)
	:	p1(_p1), p2(_p2), p3(_p3),
		e1(_p1, _p2), e2(_p2, _p3), e3(_p3, _p1)
{
}

bool Triangle2::containsVertex(const Vector3 &v)
{
	return p1 == v || p2 == v || p3 == v; 
}

bool Triangle2::circumCircleContains(const Vector3 &v)
{
